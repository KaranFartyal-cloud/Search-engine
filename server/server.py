...
def search(query, inverted_index, document_info, num_results, page):
...
try:
    inverted_index = load_inverted_index('../advanced_inverted_index.csv')
    document_info = load_document_info('../advanced_doc_info.csv')
